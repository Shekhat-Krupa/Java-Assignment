...
* each  representing a day’s attendance in a course and containing the names 
* of the students  who attended the course on that particular day, write a program that displays, 
* in  ascending order, the names of those students who have attended at least one day of the  course. 
* The text file(s) is/are passed as command-line argument(s)
*/
import java.io.*;
import java.util.*;
public class Practical_13 {
 // finction to sort the array of students
    public static void sortArr(String[] student, int k) {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println("The list of students is sorted.");
            // call the sortArray() to sort the student array and print it
            sortArr(student, counter);
        } catch (IOException e) {
